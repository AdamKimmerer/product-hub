...
:</span>
              <br/>
              <span className="meta-body"><p>Canadian Institute for Health Information. <em><a href="https://www.cihi.ca/en/ccrs_qi_risk_adj_meth_2013_en.pdf" class="external-link" rel="nofollow" target="_blank">CCRS Quality Indicators Risk Adjustment Methodology</a></em>. 2013.</p>

<p>Canadian Institute for Health Information. <em><a href="https://secure.cihi.ca/free_products/CCRS_QualityinLongTermCare_EN.pdf" class="external-link" rel="nofollow" target="_blank">When a Nursing Home Is Home: How Do Canadian Nursing Homes Measure Up on Quality?</a></em> 2013.</p>

<p>Health Quality Ontario. <em><a href="http://www.hqontario.ca/Portals/0/Documents/pr/pr-ltc-benchmarking-resource-guide-en.pdf" class="external-link" rel="nofollow" target="_blank">Long-Term Care Benchmarking Resource Guide</a></em>. 2013.</p>

<p>Health Quality Ontario. <em><a href="http://www.hqontario.ca/Portals/0/documents/system-performance/benchmark-setting-ltc-indicators-feb-2017-en.pdf" class="external-link" rel="nofollow" target="_blank">Results From Health Quality Ontario’s Benchmark Setting for Long-Term Care Indicators</a></em>. 2017.</p>

<p>Health Quality Ontario. <a href="http://indicatorlibrary.hqontario.ca/Indicator/Search/EN" class="external-link" rel="nofollow" target="_blank">Health Quality Ontario Indicator Library</a>. Accessed October 4, 2017.</p>
</span>
            </div>
            <div className="meta-item">
